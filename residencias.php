    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <img src="https://www.itsa.edu.mx/wp-content/uploads/2017/12/fondo.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
          <img src="https://llano.tecnm.mx/images/SERVICIOS-AL-ESTUDIANTE/RESIDENCIA-PROFESIONAL/Residencias-Profesionales.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSByjo1XbZiafSddfs4gdZxOENjraOWAfrojQ&usqp=CAU" class="d-block w-100" alt="...">
        </div>
      </div>
    ...
    <div class="container-tag">
      <div class="card-container">
        <div class="header-tag">
          ...
          <h2 class="text-primary">I.S.C Luis Ricardo Beltrán Peñaloza</h2>
          <h4>Jefe de Depto. de Residencias Profesionales y Servicio Social</h4>
        </div>
        <div class="descripcion">
          <p>Correo: residenciasyservicio@itsa.edu.mx</p>
          <p>Telefonos:453-534-2513 y 453-534-8300 EXT 118</p>
          <p>Movil: 453-159-6127</p>
