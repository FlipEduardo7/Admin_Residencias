...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE files SET title = '$title', description = '$description', url = '$new_name_file' WHERE id = $id";
    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="card card-body shadow-lg p-3 mb-5 bg-body rounded">
                <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data" class="shadow p-3 mb-5 bg-body rounded">
